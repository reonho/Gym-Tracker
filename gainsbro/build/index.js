...
function ManageLocationsRoute() {
  ...
  return /* @__PURE__ */ React.createElement(UserAuthorisedComponent, {
    ...
    className: "title is-3"
  }, "Locations"), workoutsForUser && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h4", {
...
var Stopwatch = (props) => {
  const [time, setTime] = (0, import_react16.useState)(props.initialTime);
...
function StartNewWorkoutRoute() {
  ...
  return /* @__PURE__ */ React.createElement(UserAuthorisedComponent, {
    ...
    running: true,
    initialTime: (0, import_dayjs13.default)() - import_dayjs13.default.utc(workout.datetime_start)
  }))), /* @__PURE__ */ React.createElement("div", null)), /* @__PURE__ */ React.createElement("div", {
    className: "buttons"
...
function CurrentExercisesRoute() {
  ...
  const [localExerciseState, setLocalExerciseState] = (0, import_react20.useState)(exerciseSets);
  const { workoutId } = (0, import_remix22.useParams)();
  const fetcher = (0, import_remix22.useFetcher)();
  (0, import_react20.useEffect)(() => setLocalExerciseState(exerciseSets), [exerciseSets]);
